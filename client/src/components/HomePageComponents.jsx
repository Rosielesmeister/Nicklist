...
import { CATEGORIES, US_STATES, REGIONS, MESSAGES, FILTER_LABELS, PAGE_CONFIG } from "../constants/HomeConstant";
...
// =============================================================================
export const PaginationComponent = ({ paginationData, currentPage, onPageChange }) => {
    ...
    <Row className="mt-4">
      <Col className="d-flex justify-content-center">
        <Pagination>
          ...
          <Pagination.Next
            onClick={() => onPageChange(Math.min(currentPage + 1, paginationData.totalPages))}
