...
import { getInitialFilters, useDebounce, matchesSearch, matchesPriceRange } from "../utils/HomeUtils";
...
export const useFilters = (products) => {
  ...
  const debouncedSearchTerm = useDebounce(filters.searchTerm, PAGE_CONFIG.SEARCH_DEBOUNCE_MS);
